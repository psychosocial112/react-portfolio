  ...
  return (
    <div className="App">
      <div className="content">
			<img className="logo" src={ logo } alt="sapious logo" />
			<div className="card">
				<div className="profile">
					...
					<div className="contact">
						...
						<div className="social">
							<a href="https://www.facebook.com/anas.atallah.18/" target="_blank" rel="noopener noreferrer">
								<img src={facebook} alt="Facebook" />
							</a>
							<a href="https://github.com/psychosocial112" target="_blank" rel="noopener noreferrer">
								<img src= {github} alt="Github" />
							</a>
							<a href="https://www.linkedin.com/in/anas-atallah/" target="_blank" rel="noopener noreferrer">
